...
$(document).ready(function() {
    ...
    const ARCANA = { "성배": ALL_SKILLS, "양피지": ["격파쇄","돌진 격파","열파격","암격쇄","쾌유의 주문","파동격"], "나침반": ["백열격","타격쇄","회전격","진동쇄","질풍 난무","충격 해제"], "종": ["생명의 축복","보호진","공격준비","격노의 주문","대지의 약속"], "거울": ["십자방어","고취의 주문","바람의 약속","생존의지","충격 적중"], "천칭": ALL_SKILLS };
    ...
    $('#btnDream').on('click', function() {
        ...
        const data = {
            ...
            "양피지": { t:"card", s: {"쾌유의 주문":3, "암격쇄":2, "격파쇄":2, "돌진 격파":2}},
            "나침반": { t:"card", s: {"회전격":3, "타격쇄":2, "진동쇄":2, "백열격":2}},
            "성배": { t:"card", s: {"격파쇄":3, "돌진 격파":2, "진동쇄":2, "백열격":2}},
            "천칭": { t:"card", s: {"암격쇄":3, "쾌유의 주문":2, "회전격":2, "타격쇄":2}},
            "종": { t:"card", s: {"공격준비":5, "생명의 축복":2, "대지의 약속":1, "보호진":1}},
            "거울": { t:"card", s: {"고취의 주문":5, "충격 적중":2, "십자방어":1, "생존의지":1}}
        };
